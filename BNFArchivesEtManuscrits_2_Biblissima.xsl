...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!-- Transformation de fichiers EAD de BnF Archives et Manuscrits de Miroir des Classiques vers XML pivot Biblissima en se basant sur le XSL créé dans le cadre de Europeana Regia (https://sourceforge.net/projects/eregia2eseedm/) - Stefanie Gehrke 2014 et Septembre - Novembre 2016 pour Biblissima -->
